$(function () {
    ...
    $('#modalEditTimePayment').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget)
        var id = button.data('id')
        var timepayment = button.data('timepayment')
        var description = button.data('description')
        var modal = $(this)

        modal.find('.modal-body #id_time_payment').val(id);
        modal.find('.modal-body #time_payment_e').val(timepayment);
