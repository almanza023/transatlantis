...
<!-- LARGE MODAL -->
<div id="modalEditTimePayment" class="modal fade">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content tx-size-sm">
         ...
         <div class="modal-body pd-20">
            ...
            <form class="form-horizontal" id="form_edit"  method="POST" action="{{ route('timepayment.update', 'timepayment') }}">

                @csrf
                @method('PATCH')

                <input type="hidden" name="id_time_payment" id="id_time_payment">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-12 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="number" class="form-control" id="time_payment_e" name="time_payment"  required>                   
                            </div>
                        </div>
                    </div>
                </div>
