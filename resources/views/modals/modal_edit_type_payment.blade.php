...
<!-- LARGE MODAL -->
<div id="modalEditTypePayment" class="modal fade">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content tx-size-sm">
         ...
         <div class="modal-body pd-20">
            ...
            <form class="form-horizontal" id="form_edit"  method="POST" action="{{ route('typepayment.update', 'typepayment') }}">

                @csrf
                @method('PATCH')

                <input type="hidden" name="id_type_payment" id="id_type_payment">
               
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-2 col-sm-4 col-xs-5 form-control-label">
                        <label for="type_payment_e">Tipo de Pago: </label>
                    </div>
                    <div class="col-lg-12 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" id="type_payment_e" name="type_payment"  required>                   
                            </div>
                        </div>
                    </div>
                </div>
