...
<!-- LARGE MODAL -->
<div id="modalCreateTypePayment" class="modal fade">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content tx-size-sm">
         ...
         <div class="modal-body pd-20">
            ...
            <form class="form-horizontal"  id="form_validation" method="POST" action="{{ route('typepayment.store') }}">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-12 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" id="type_payment" name="type_payment"  required>                   
                            </div>
                        </div>
                    </div>
                </div>
