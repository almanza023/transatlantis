...
<!-- LARGE MODAL -->
<div id="modalCreateTypeProvider" class="modal fade">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content tx-size-sm">
         ...
         <div class="modal-body pd-20">
            ...
            <form class="form-horizontal"  id="form_validation" method="POST" action="{{ route('typeprovider.store') }}">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-2 col-sm-4 col-xs-5 form-control-label">
                        <label for="type_provider">Tipo de Proveedor: </label>
                    </div>
                    <div class="col-lg-12 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" id="type_provider" name="type_provider"  required>                   
                            </div>
                        </div>
                    </div>
                </div>
