			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="card-header bg-warning">
						<h2 class="text-center font-bold " style="color:white"><b>REGISTRO DE COTIZACIONES - CLIENTES</b></h2>
					...
					<div class="card-body">
						...
						<fieldset>
							...
							<div class="col-md-12 col-sm-3">
								<input id="total_items" type="hidden"  class="form-control" name="total_items" value="Total: $0.0" readonly>
							</div>				
