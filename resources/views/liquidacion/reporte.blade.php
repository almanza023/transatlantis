			...
			<div class="card">
				<div class="card-header bg-warning">
					<h2 class="text-center font-bold col-deep-purple font-42">
					    REPORTE DE LIQUIDACION DE CONDUCTOR
					</h2>					
				</div>
				<div class="card-body">
					<div class="table-wrapper">
						<form id="form_filter_liquidacion" method="post" action="{{route('liquidacion.show')}}" target="_blank">
							 @csrf  
                            <div class="row">
                                    
                                        <div class="col-md-6">	
                                            <label  class="form-label font-bold col-cyan">Filtrar Por: Conductor</label>
                                            <div class="form-group form-float form-float">
                                                <div class="form-line">
                                                    <select class="form-control show-tick" name="nid_driver">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <button type='button' id="btn_filter_liquidacion"  class='btn btn-primary'><li class="fa fa-print"></li> GENERAR PDF </button>
                                            </div>              
                                        </div>             
